...
- публикуется только из canonical nested path `submissions/<author-slug>/<theme-slug>.json`

Legacy flat timestamp files в корне `submissions/` считаются временным источником только для миграции и не должны быть основным published source.
